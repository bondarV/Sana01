...
if (c * d != 0 && c - d != 0 && b != 0)
{
    Console.WriteLine("Значення змiнної х ="); Console.WriteLine(x);
}
else Console.WriteLine("Знаменник виразу змiнної {x} не може дорівнювати нулю");

if (c != 0 && b != a)
{
    Console.WriteLine("Значення змiнної y ="); Console.WriteLine(y);
}
else Console.WriteLine("Знаменник виразу змiнної {y} не може дорівнювати нулю");

if (5 * a + 3 * b != 0)
{
    Console.WriteLine("Значення змiнної z ="); Console.WriteLine(z);
}
else Console.WriteLine("Знаменник виразу змiнної {z} не може дорівнювати нулю");

if (3 * c + 1 != 0 && a - c != 0)
{
    Console.WriteLine("Значення змiнної r ="); Console.WriteLine(r);
}
