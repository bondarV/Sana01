...
if (Math.Sqrt(Math.Pow(m, 3) * n) + n * m + m * m - m != 0 || Math.Pow(m, 3) * n >= 0 || n >= 0 || m >= 0)
{
    Console.WriteLine("Значення змiнної z1 ="); Console.WriteLine(z1);
}
else Console.WriteLine("Знаменник виразу змiнної {z1} не може дорівнювати нулю");

if (m != 0)
{
    Console.WriteLine("Значення змiнної z2 ="); Console.WriteLine(z2);
}
else Console.WriteLine("Знаменник виразу змiнної {z2} не може дорівнювати нулю");

Console.WriteLine($"Значення змiнної y = {y}");
